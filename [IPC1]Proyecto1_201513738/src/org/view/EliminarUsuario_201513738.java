...
public class EliminarUsuario_201513738 extends JFrame implements ActionListener{
    ...
    public EliminarUsuario_201513738(InicioAdmin_201513738 instancia){
        configurarVentana();
    ...
    private void configurarVentana() {
        this.setTitle("Eliminar Usuario");                   // colocamos titulo a la ventana
        ...
        if (e.getSource() == btnAceptar){
             if (!txtId.getText().equals("") && !txtNombre.getText().equals("") && !txtApellido.getText().equals("") && !txtNickname.getText().equals("") && !txtPass.getText().equals("")){
                    if (this.instanciaPrincipal.getPrincipal().listUsuarios.verificarUsuario(txtId.getText())){
                        this.instanciaPrincipal.getPrincipal().listUsuarios.eliminarUsuario(DPI);
                        DPI = "";
                        txtId.setText("");
                        txtNombre.setText("");
                        txtNickname.setText("");
